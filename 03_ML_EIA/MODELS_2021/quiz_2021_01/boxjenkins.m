...
yarx = arx(data,[4,8,0]) % [na=taken_from_window_size_of_input, nb=1, nk=0]
...
subplot(4,1,4);
plot(k,yd,'b',k,ys1,'r', "linewidth", 2); % ARX
% plot(k,yd,'b',k,ys2,'r', "linewidth", 2); % MAX
% plot(k,yd,'b',k,ys3,'r', "linewidth", 2); % ARMAX
