% LOADING DATA "STRAIGHT LINE" EXECUTING ADALINE
...
% Add Bias and custom entries to have more diversity of "inputs"
...
for i=1:ns
    ...
    prettygraph("STRAIGHT LINE MODEL ADALINE (MSE)","plot");
end
